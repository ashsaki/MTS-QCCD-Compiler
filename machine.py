    ...
    def split_time(self, sys_state, trap_id, seg_id, ion1):
        ...
        if ion1 == ion2:
            ...
            if mp.swap_type == "GateSwap":
                ...
                i1 = ion1
                i2 = ion2
                # New `sys_state` where ion1 and ion2 positions (indices) are swapped
                # In IonBased SWAP it is not needed
                sys_state.trap_ions[trap_id][p1], sys_state.trap_ions[trap_id][p2] = sys_state.trap_ions[trap_id][p2], sys_state.trap_ions[trap_id][p1]
        ...
        return int(split_estimate), split_swap_count, split_swap_hops, i1, i2, ion_swap_hops, sys_state
